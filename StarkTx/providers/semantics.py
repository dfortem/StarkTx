...
from StarkTx.providers.sequencer import get_abi
from StarkTx.decoders.abi import decode_abi
...
def get_semantics(contract: str) -> dict:
    ...
    if contract in semantics:
        ...
        contract_semantics = dict(contract=contract, name=contract[:10], abi=decoded_abi)
